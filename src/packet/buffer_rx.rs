...
impl Depacketized {
    ...
    pub fn ext_vals(&self) -> ExtensionValues {
        ...
        // abs_capture_time from str0m always exists in the first packet.
...
mod test {
    ...
    #[test]
    fn ext_vals_merges_first_and_last_packet() {
        ...
        let first_header = RtpHeader {
            ...
            ext_vals: ExtensionValues {
                abs_capture_time: Some(abs_capture_time.clone()),
                ..Default::default()
            },
            header_len: 0,
        };
